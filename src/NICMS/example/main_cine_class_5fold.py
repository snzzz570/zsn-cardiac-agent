...
def parse_args():
    ...
    parser.add_argument("--lst_file", default="/home/qutaiping/nas/processed_data/processed_data_diag_second_refine/val_fold5.lst", type=str)
    parser.add_argument("--patients_root", default="/home/qutaiping/nas/ori_data/diagnosis_second/patients_refine", type=str)
    parser.add_argument("--output_path", default="/home/qutaiping/nas/code/diagnosis_second/results/5fold_refine", type=str)
    parser.add_argument(
        "--model_path",
    ...
    parser.add_argument(
        "--model_cls_file", 
        default='/home/qutaiping/nas/checkpoints/diagnosis_second_5fold_refine2/fold5/epoch_50.pth',
        type=str,
    )
    parser.add_argument(
        "--network_cls_file", 
        default="/home/qutaiping/nas/code/diagnosis_second/train/config/cine_class_config_5fold.py", 
        type=str,
    )
    parser.add_argument(
        "--config_file", 
        default="/home/qutaiping/nas/code/diagnosis_second/example/cls.yaml",
        type=str, 
    )
    parser.add_argument(
        "--csv_path",
