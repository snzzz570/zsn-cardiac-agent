...
data = dict(
    ...
    train=dict(
        type="Infar500bClassificationReSampleDataset",
        root="/home/qutaiping/nas/processed_data/processed_data_infar_class_resample",
        dst_list_file="/home/qutaiping/nas/processed_data/processed_data_infar_class_resample/train_b.lst",
    ...
    val=dict(
        type="Infar500b_Cls_ReSampleDataset_Val",
...
lr_config = dict(policy="step", warmup="linear", warmup_iters=10, warmup_ratio=1.0 / 3, step=[5, 35, 70], gamma=0.2)
...
work_dir = "/home/qutaiping/nas/checkpoints/infar_class_flow_b_finetune"
gpus = 4
...
deterministic = False
resume_from = None
load_from = "/home/qutaiping/nas/checkpoints/infar_class_flow_b_finetune/latest.pth"
workflow = [("train", 1)]