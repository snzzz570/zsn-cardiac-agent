...
data = dict(
    ...
    train=dict(
        ...
        root="/home/qutaiping/nas/processed_data_JFJ_class_resample_addflow3",
        dst_list_file="/home/qutaiping/nas/processed_data_JFJ_class_resample_addflow3/train.lst",
...
work_dir = "/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine-JFJ2"
gpus = 4
...
seed = None
deterministic = False
resume_from = None #"/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine-JFJ/latest.pth"
load_from = "/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine/latest.pth"
workflow = [("train", 1)]