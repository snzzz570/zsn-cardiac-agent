...
data = dict(
    ...
    train=dict(
        ...
        root="/home/qutaiping/nas/processed_data_BLCG_class_resample_addflow",
        dst_list_file="/home/qutaiping/nas/processed_data_BLCG_class_resample_addflow/train2.lst",
...
optimizer = dict(type="AdamW", lr=1e-5, weight_decay=5e-4)
optimizer_config = {}

lr_config = dict(policy="step", warmup="linear", warmup_iters=10, warmup_ratio=1.0 / 3, step=[25], gamma=0.2)
...
work_dir = "/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine-2"
gpus = 4
...
seed = None
deterministic = False
resume_from = "/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine-2/latest.pth"
load_from = "/home/qutaiping/nas/checkpoints/BLCG_class_flow_newmove_refine-2/latest.pth"
workflow = [("train", 1)]
