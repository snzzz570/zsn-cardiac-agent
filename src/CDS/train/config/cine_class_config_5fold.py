...
data = dict(
    ...
    train=dict(
        ...
        root="/home/qutaiping/nas/processed_data/processed_data_diag_first_refine",
        dst_list_file="/home/qutaiping/nas/processed_data/processed_data_diag_first_refine/train_fold{fold}.lst",
    ...
    val=dict(
        ...
        root="/home/qutaiping/nas/processed_data/processed_data_diag_first_refine",
        dst_list_file="/home/qutaiping/nas/processed_data/processed_data_diag_first_refine/val_fold{fold}.lst",
        patch_size_24=patch_size_24,
        patch_size_sa=patch_size_sa,
        # patch_size=patch_size,
        rotation_prob=0.0,
...
work_dir = "/home/qutaiping/nas/checkpoints/diagnosis_first_5fold/fold{fold}"
gpus = 1
